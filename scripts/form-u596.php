...
{
	$to = '';
	$subject = 'WidgetsLibrary::simple_contact Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>NOMBRE O RAZÓN SOCIAL:</b></td><td>' . htmlentities($_REQUEST["custom_U624"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>MENSAJE:</b></td><td>' . htmlentities($_REQUEST["custom_U602"],ENT_COMPAT,'UTF-8') . '</td></tr>';
